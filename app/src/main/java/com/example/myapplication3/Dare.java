...
public class Dare extends AppCompatActivity {
    ImageView image;
    TextView text;
    String[] sectors = { "have coffee for breakfast", "have spaghetti for dinner","watch TV", "watch youtube videos","visit relatives",
            "do sport","have lunch with your family", "have arguments with your siblings","go on holidays", "take out the rubbish",
            "get up late","do the housework" };
    @Override
